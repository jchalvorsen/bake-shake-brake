...
load -ASCII coordinates.dat;
eval('load -ASCII elements3.dat;','elements3 = [];');
eval('load -ASCII elements4.dat;','elements4 = [];');
eval('load -ASCII neumann.dat;','neumann = [];');
load -ASCII dirichlet.dat;
